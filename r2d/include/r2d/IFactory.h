...
namespace r2d {
	...
	public:
		...
		virtual std::auto_ptr<IDynamicGeometeryObject> CreateGraphicObject(IMaterial* materialPtr, const Polygon2d& geometry, const Rect& uv = Rect(0.0f, 0.0f, 1.0f, 1.0f), int z = 0, const AnimationProperties& animationProperties = AnimationProperties()) const = 0;
	};
}
